<template>
  <div class="card">
    ...
    <div class="card-content">
      ...
      <b-table :data="customers" hoverable paginated :per-page="5" :loading="isLoaded">
        <b-table-column field="customer_id" label="ID" width="10" numeric v-slot="props">
        ...
        <b-table-column label="actions" width="100" centered v-slot="props">
          <b-button @click="updateCustomer(props.row)" label="แก้ไข" type="is-warning" /> &nbsp;
  ...
  methods: {
    ...
    confirmDelete(customer) {
      this.$buefy.dialog.confirm({
        title: 'ลบลูกค้า ',
        message: `คุณต้องการลบลูกค้า: <b>${customer.name}</b> ใช่ไหม?`,
        type: 'is-danger',
        onConfirm: () => this.$emit('delete:customer', customer),
      })
    },
  },
}
